...
NS3_PEG_prebuild_spontaneous = {'sessions': sessions, 'neuron_IDs': neuron_IDs, 'all_sess_resps': all_sess_resps, 
                                'silence_times': spont_times}

# save pre-built dataset file
'''f = open('NS3_PEG_prebuild_spontaneous.pckl', 'wb')
pickle.dump(NS3_PEG_prebuild_spontaneous, f)
f.close()'''